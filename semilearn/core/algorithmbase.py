...
class AlgorithmBase:
    ...
    def set_dataset(self):
        ...
        dataset_dict = get_dataset(self.args, self.algorithm, self.args.dataset, self.args.num_labels, self.args.num_classes, self.args.data_dir, exp_type=self.args.exp_type)
